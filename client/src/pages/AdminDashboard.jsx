...
function AdminDashboard() {
     ...
     async function handleProjectReorder(
          ...
          try {
               ...
               const response =
                    await fetch(
                         `/api/admin/projects/${project._id}/order`,
                         {
                              method: "PATCH",
                              ...
                              .map(
                                   (
                                        ...
                                        return {
                                             ...
                                             published:
                                                  currentProject.publicationStatus ===
                                                       "published"
                                                       ? {
                                                                                     ...
                                                                                     >
                                                                                          ...
                                                                                          <div className="admin-project-actions">
                                                                                               {!project.isArchived &&
                                                                                                    currentOrder && (
                                                                                                         <div
                                                                                                              className="admin-project-order-controls"
                                                                                                              aria-label={`Reorder ${getProjectTitle(
                                                                                                                   project
                                                                                                              )}`}
                                                                                                         >
                                                                                                              <button
                                                                                                              ...
                                                                                                              <label className="admin-project-order-select">
                                                                                                                   <span>
                                                                                                                        Position
                                                                                                                   </span>
                                                                                               ...
                                                                                               {project.isArchived && (
                                                                                                    <span className="admin-project-order-note">
