    ...
    return (
        <>
            ...
            <main className="home-page about-page">
                <section
                    className="home-section about-page-hero"
                    aria-labelledby="about-title"
                >
                    <div className="section-heading about-page-intro">
                        <p className="eyebrow">About</p>

                        <h1 id="about-title">
                            Building where product, design, and engineering meet.
                        </h1>
                    ...
                    <div className="content-card about-page-card">
                        <h2>What I do</h2>
