const projects = [
  {
    ...
    solution:
      "I am building a MERN application with a structured frontend, project data, case study patterns, a contact form, and a future admin dashboard.",
  ...
  },
  {
    ...
    solution:
      "This placeholder helps test the card layout before final project content is added.",
  ...
  },
  {
    ...
    problem:
      "The portfolio needs to support several project types without breaking the design or forcing every card to have the exact same content length.",
    solution:
